...
Revision ID: c69715d36c3f
Revises: 3c1ba38bc114
Create Date: 2023-10-12 10:34:30.833445
...
def upgrade() -> None:
    ...
    sa.Column('order', sa.Integer(), autoincrement=True, nullable=False, comment='排序值'),
    ...
    op.create_table('userdepartmentassociation',
    sa.Column('user_id', sa.Integer(), nullable=False),
    sa.Column('department_id', sa.String(), nullable=False),
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False, comment='主键'),
    sa.Column('create_at', sa.DateTime(), nullable=False, comment='创建时间'),
    sa.Column('updated_at', sa.DateTime(), nullable=False, comment='更新时间'),
    sa.ForeignKeyConstraint(['department_id'], ['department.key'], ),
    sa.ForeignKeyConstraint(['user_id'], ['user.id'], ),
    sa.PrimaryKeyConstraint('user_id', 'id')
    )
    op.add_column('dictionary', sa.Column('order', sa.Integer(), autoincrement=True, nullable=False, comment='排序值'))
    ...
    op.alter_column('dictionary', 'key',
               existing_type=sa.VARCHAR(),
               nullable=True,
               comment='索引key',
               existing_comment='字典编号')
    op.drop_column('dictionary', 'sort')
    op.add_column('dictionarykeyvalue', sa.Column('order', sa.Integer(), autoincrement=True, nullable=False, comment='排序值'))
    op.alter_column('dictionarykeyvalue', 'parent_id',
               existing_type=sa.INTEGER(),
               type_=sa.String(),
               existing_nullable=False)
    op.drop_constraint('dictionarykeyvalue_parent_id_fkey', 'dictionarykeyvalue', type_='foreignkey')
    op.create_foreign_key(None, 'dictionarykeyvalue', 'dictionary', ['parent_id'], ['key'])
...
def downgrade() -> None:
    ...
    op.alter_column('user', 'id',
               ...
               existing_nullable=False,
               autoincrement=True)
    op.add_column('dictionarykeyvalue', sa.Column('sort', sa.INTEGER(), autoincrement=False, nullable=False, comment='排序编号'))
    op.drop_constraint(None, 'dictionarykeyvalue', type_='foreignkey')
    op.create_foreign_key('dictionarykeyvalue_parent_id_fkey', 'dictionarykeyvalue', 'dictionary', ['parent_id'], ['id'])
    op.alter_column('dictionarykeyvalue', 'parent_id',
               existing_type=sa.String(),
               type_=sa.INTEGER(),
               existing_nullable=False)
    op.drop_column('dictionarykeyvalue', 'order')
    op.add_column('dictionary', sa.Column('sort', sa.INTEGER(), autoincrement=False, nullable=False, comment='排序编号'))
    op.alter_column('dictionary', 'key',
               existing_type=sa.VARCHAR(),
               nullable=False,
               comment='字典编号',

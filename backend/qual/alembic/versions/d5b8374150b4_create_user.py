...
Revision ID: d5b8374150b4
Revises: 
Create Date: 2023-09-15 14:53:47.046080
...
def upgrade() -> None:
    ...
    sa.Column('res_id', sa.String(), nullable=False),
    sa.Column('name', sa.String(), nullable=False),
    sa.PrimaryKeyConstraint('res_id')
    )
    op.create_index(op.f('ix_devices_name'), 'devices', ['name'], unique=False)
    op.create_index(op.f('ix_devices_res_id'), 'devices', ['res_id'], unique=True)
...
def downgrade() -> None:
    ...
    op.drop_table('users')
    op.drop_index(op.f('ix_devices_res_id'), table_name='devices')
